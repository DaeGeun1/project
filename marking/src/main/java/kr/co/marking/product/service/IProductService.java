...
public interface IProductService {
	...
	public boolean insertProduct(ProductDTO pDto);           						 // 상품 추가 기능
	...
	public boolean updateProductViewCount(String product_no);						 //상품 클릭시 조회수 +1 
	
	public int selectProductTotalCount(Map<String, Object> map);  					 //상품 총 갯수 출력
	
	public boolean deleteProduct(String product_no);                        		 //상품 삭제
	...
	public boolean updateProductOrderCount(String product_no, String product_order, String product_salesamount);    //주문시 상품 주문수량 판매량 업데이트
}
