			...
			<div class="col-sm-9 col-md-7 col-lg-7 mx-auto">
				<div class="card border-0 shadow rounded-3 my-5">
					<div class="card-body p-4 p-sm-5">
						...
						<form action="${contextPath}/member/join" method="post" name="frm">
							...
							<div class="form-floating mb-2">
								...
								<label for="member_password">비밀번호[영문/숫자/특수문자(!@#$?) 8~16자]</label>
								<span class="fs-6 text-danger" id="span-member-password">　</span>
							</div>
							<div class="form-floating mb-2">
								<input type="password" class="form-control" id="member_password_check" name="member_password_check" placeholder="text" maxlength="20"> 
								<label for="member_password_check">비밀번호 확인</label>
								<span class="fs-6 text-danger" id="span-member-password-check">　</span>
							</div>
							<div class="form-floating mb-2">
							...
							<div class="form-floating mb-2">
								<input type="text" class="form-control pe-none bg-white w-50 float-start" id="member_post" name="member_post" placeholder="text" maxlength="10" readonly> 
							...
							<div class="form-floating mb-2">
								<input type="text" class="form-control pe-none bg-white" id="member_basicaddress" name="member_basicaddress" placeholder="text" maxlength="33" readonly> 
								<label for="member_basicaddress">기본 주소</label>
								<span class="fs-6 text-danger" id="">　</span>
								
							</div>
							<div class="form-floating mb-2">
								<input type="text" class="form-control" id="member_detailaddress" name="member_detailaddress" placeholder="text" maxlength="33"> 
								<label for="member_detailaddress">상세 주소(선택가능)</label>
								<span class="fs-6 text-danger" id="">　</span>
							</div>
							<div class="form-floating mb-2">
								<input type="text" class="form-control float-start" style=" width : 65%;" id="member_email" name="member_email" placeholder="text" maxlength="40"> 
								<input class="btn btn-dark btn-login fw-bold sub-hover btn-email" id="btn-email" style="width: 30%; height: 58px; margin-left: 5%" value="인증보내기" type="button"/>
								<label for="member_email">이메일 (ex : marking.com)</label>
								<span class="fs-6 text-danger" id="span-member-email">　</span>
							</div>
							<div class="form-floating mb-2" id="join-email-check" style="display: none;">
								<input type="text" class="form-control" style="float: left; width : 65%;" id="member_email_check" name="member_email_check" placeholder="text" maxlength="10"> 
								<input class="btn btn-dark  btn-login fw-bold sub-hover email-check-btn" style="width: 30%; height: 58px; margin-left: 5%" value="인증확인" type="button" />
								<label for="member_email_check">인증번호</label>
								<span class="fs-6 text-danger" id="span-member-email-check">　</span>
							</div>
							
							<div class="form-floating mb-2">
								<input type="text" class="form-control" id="member_tel" name="member_tel" placeholder="text" maxlength="11"> 
								<label for="member_tel">전화번호 ( - 제외한 숫자 10~11자리)</label>
								<span class="fs-6 text-danger" id="span-member-tel">　</span>
							</div>
							<hr class="dropdown-divider" />
							<h2 class="card-title text-center my-4 fw-bold fs-4">필수약관</h2>
							<div class="form-floating mb-3">
					            <textarea class="form-control bg-white user-select-none"  placeholder="Message" style="height: 10rem; resize: none;" disabled="disabled">
제1조(목적)
이 약관은 마킹 회사(전자상거래 사업자)가 운영하는 마킹 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
제2조(정의)
① “몰”이란 마킹 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
부 칙(시행일) 이 약관은 2009년 10월 05일부터 시행합니다. 부 칙(시행일) 이 약관은 2009년 10월 05일부터 시행합니다.  		
					            </textarea>
					        </div>
					         <div class="mb-3 text-end" >
					            <div class="form-check form-check-inline">
					                <input class="form-check-input" id="member_essentialO" type="radio" name="member_essential" value="Y" />
					                <label class="form-check-label" for="member_essentialO">동의함</label>
					            </div>
					            <div class="form-check form-check-inline">
					                <input class="form-check-input" id="member_essentialX" type="radio" name="member_essential" value="N" checked="checked"/>
					                <label class="form-check-label" for="member_essentialX">동의안함</label>
					            </div>
					        </div>
					        <h2 class="card-title text-center my-4 fw-bold fs-4">선택약관</h2>
							<div class="form-floating mb-3">
					            <textarea class="form-control bg-white user-select-none" placeholder="Message" style="height: 10rem; resize: none;" disabled="disabled">
...
선택 약관에 동의하지 않으셔도 회원가입은 가능하며, 회원가입 후 회원정보수정 페이지에서 언제든지 수신여부를 변경하실 수 있습니다
					         ...
					         <div class="mb-3 text-end">
					            <div class="form-check form-check-inline">
					                <input class="form-check-input" id="member_selectO" type="radio" name="member_select" value="Y" />
					                <label class="form-check-label" for="member_selectO">동의함</label>
					            </div>
					            <div class="form-check form-check-inline">
					                <input class="form-check-input" id="member_selectX" type="radio" name="member_select" value="N" checked="checked"/>
					                <label class="form-check-label" for="member_selectX">동의안함</label>
					            </div>
					        </div>
							<div class="d-grid mb-3">
								<input type="submit" value="회원가입" class="btn btn-dark btn-login text-uppercase fw-bold main-hover" id="btn-login">
							</div>
							<div class="d-grid">
	...
	$(document).ready(function(){
		...
		$("#member_id").on("blur", function(){
			...
			if(id == "") {                                        // 빈칸 유효성 체크
				...
				$.ajax({
					type : "post",
					url : "${contextPath}/member/memberIdCheck",
					...
					success : function(data) {
						if(data == true) {
							document.getElementById("member_id").classList.add("is-invalid");
							document.getElementById("span-member-id").innerText= id + "는 중복된 아이디 입니다.";
							document.getElementById("member_id").value= "";
						} else if(data == false) {
							document.getElementById("member_id").classList.remove("is-invalid");
							document.getElementById("member_id").classList.add("is-valid");
							document.getElementById("span-member-id").innerText="　";
						} else {
		...
		$("#member_password_check").on("blur", function(){
		...
		$('.btn-email').on('click', function(e){
			...
			if(email == "") {                                       					// 빈칸 유효성 체크
				...
				$.ajax({
					...
					success : function(result) {
						if (result == "") {
							document.getElementById("member_email").classList.add("is-invalid");             <%-- 부적합 표시 --%> 
							document.getElementById("span-member-email").innerText="인증전송 실패 : 중복된 이메일";  <%-- 부적합 원인 --%>
							return false;
						} else if (result != ""){
							console.log("인증번호는 : " + result)
							document.getElementById("member_email").classList.add("pe-none");                 <%-- 적합 표시 --%>        
							document.getElementById("join-email-check").style.display = "block";              <%--인증번호 창 띄우기 --%>
							email_authentication = result;
						} else {
							fnModal("ajax success but error");   
						}
		...
		$("#btn-login").on("click",function(e) {
			...
			var password_check = $("#member_password_check").val();
			var name = $("#member_name").val();
			var post = $("#member_post").val();
			var email = $("#member_email").val();
			var tel = $("#member_tel").val();
			var essential = $("input:radio[name='member_essential']:checked").val();
			var email_authentication_check = $("#member_email_check").val();
			
			if(id == "" || !(id_reg.test(id))) {
				fnModal("아이디를 확인해주세요");
				$("#member_id").focus();
				return false;
				...
				return false;
			} else if (password_check == "" || password_check != password) {
				...
				$("#member_post").focus();
				return false;
			} else if(email == "" || !(email_reg.test(email)) || email_authentication == "" || email_authentication != email_authentication_check ) {
				fnModal("이메일을 확인해주세요");
				$("#member_email").focus();
				return false;
			} else if(email_authentication == "" ) {
				fnModal("이메일 인증을 해주세요");
				$("#member_email").focus();
				return false;
			} else if(email_authentication != email_authentication_check ) {
				fnModal("이메일 인증번호를 확인해주세요");
				$("#member_email").focus();
				return false;
